...
sudo apt-get install -y \
    ...
    waybar mako-notifier fuzzel rofi \
...
echo "  Themes         : nord · gruvbox · classic · latte · sunset · purplerange · pinksky"
echo "                   (switch: Mod+x, or theme-switch.sh <name>)"
echo "  Wallpaper      : Mod+w  (random from ~/Pictures/wallpapers)"
echo "                   sunset/purplerange/pinksky each pin their own"
